// Coordinates for all 41 Romanian county seats + Bucharest
// Used for distance-based location filtering (Haversine formula)
...
// Returns coordinates for a city name (case-insensitive, diacritic-tolerant)
export function getCityCoords(cityName) {
    ...
    // Partial match: city starts with typed value (handles "Timișoara" vs "Timisoara")
    for (const [key, coords] of Object.entries(ROMANIA_CITIES)) {
...
export const WIDER_RADIUS_KM  = 150;
