    ...
    return (
        ...
        >
                ...
                {!isSubmitted ? (
                    <form onSubmit={handleSubmit}>
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className='w-full py-3 px-4 bg-gradient-to-r from-violet-500 to-purple-600 text-white font-bold rounded-lg shadow-lg hover:from-violet-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-purple-900 transition duration-200'
                            type='submit'
                        >
            ...
            <div className='px-8 py-4 bg-gray-300 bg-opacity-50 flex justify-center'>
                <Link to={"/login"} className='text-sm text-violet-400 hover:underline flex items-center'>
