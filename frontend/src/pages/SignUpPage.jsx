                ...
                <form onSubmit={handleSignUp} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                    {fields.map(({ id, type, label, placeholder, value, onChange, icon: Icon }) => (
                        <div key={id}>
                            ...
                            <div style={{ position: 'relative' }}>
                                <Icon style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)', width: '15px', height: '15px', color: '#9C7B6A' }} />
                                <input
                                    id={id}
                                    type={type}
                    ...
                    <motion.button
                        ...
                        style={{
                            ...
                            padding: '12px',
                            borderRadius: '12px',
                            backgroundColor: isLoading ? '#9C7B6A' : '#D4967A',
                            color: '#FDF8F5',
                            fontSize: '13px',
                            fontWeight: 500,
                            border: 'none',
                    ...
                    >
                        {isLoading ? <Loader className="w-4 h-4 animate-spin mx-auto" /> : "Create account"}
                    </motion.button>
